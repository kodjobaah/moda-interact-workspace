...
title: Define commerce capability and evidence contracts
...
# Define commerce capability and evidence contracts
...
Publishable runtime contracts describe the MCP boundary without coupling consumers to database or provider internals.
...
src/commerce schemas, pure selection helpers, package export metadata and focused schema tests.
...
- [ ] Export ./commerce with supported schema/runner compatibility rules and fixture manifests; do not publish the package in this task.
