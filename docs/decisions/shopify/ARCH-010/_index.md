...
| ARCH-010-SHOPIFY-002 | Complete | Persist Free-plan selection intent, verify current Shopify subscription, preserve/create exact provider Free BillingPeriod when available, and publish durable-reconstructable reconciliation work when activation/cycle verification is unresolved. |
