...
Current counts: `complete` 18, `ready` 1, `pending` 3, `superseded` 5
...
| `SHOPIFY-026` | Build dedicated purchased-credit history and refund-management UI | **Ready** | ARCH-010-SHOPIFY-025, ARCH-010-SHOPIFY-012 |
