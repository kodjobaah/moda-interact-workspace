...
| SHOPIFY-004 | Let merchants request repeatable recovery-credit packs | **Ready — Changes Requested; next claim Attempt 2** | SHOPIFY-002, DATABASE-005, SHARED-006, ADMIN-005 |
...
- SHOPIFY-004 Attempt 1 received Changes Requested; dependencies remain Complete and the same task is Ready for Attempt 2.
