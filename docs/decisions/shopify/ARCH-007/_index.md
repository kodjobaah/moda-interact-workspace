...
| SHOPIFY-004 | Let merchants request repeatable recovery-credit packs | **Ready — Changes Requested; next claim Attempt 3** | SHOPIFY-002, DATABASE-005, SHARED-006, ADMIN-005 |
...
- SHOPIFY-004 Attempt 2 received Changes Requested; substantive Attempt 2 corrections are preserved and the same task is Ready for a narrow Attempt 3 close-out.
