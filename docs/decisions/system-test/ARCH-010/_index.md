...
| ARCH-010-SYSTEM-TEST-005 | Pending / manual-gated | Validate the Admin upgrade-economics guardrail, FAIL/UNVERIFIED atomic blocking, audit evidence and exclusion of merchant balances/promotions. |
