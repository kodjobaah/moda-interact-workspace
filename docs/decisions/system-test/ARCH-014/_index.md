...
| [ARCH-014-SYSTEM-TEST-002](SYSTEM-TEST-002-multilingual-promotions.md) | pending | Terminal multilingual promotion XLSX -> 20-locale persistence -> exact merchant-locale validation; now also waits for ADMIN-010 parser hardening. |
