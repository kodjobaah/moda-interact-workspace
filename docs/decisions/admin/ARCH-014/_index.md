...
| [ARCH-014-ADMIN-004](ADMIN-004-complete-builder-content-and-translation-gating.md) | ready | Complete the builder with human-readable placement, ordered merchant plan-card highlights, translation JSON v2/retention, portfolio-step gating and server-authoritative final review. |
