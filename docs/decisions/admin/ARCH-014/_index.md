...
| [ARCH-014-ADMIN-006](ADMIN-006-prefilled-xlsx-translation-workbook.md) | ready | Establish the single `exceljs@4.4.0` Admin spreadsheet standard and replace human-facing MerchantPricing JSON with a pre-populated XLSX workbook. |
...
| [ARCH-014-ADMIN-008](ADMIN-008-multilingual-promotion-xlsx.md) | pending | Reuse the ADMIN-006 XLSX standard to author exact 20-locale promotion merchant title/description and gate activation on 20/20. |
