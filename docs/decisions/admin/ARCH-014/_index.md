...
| [ARCH-014-ADMIN-003](ADMIN-003-remove-superseded-admin-plan-management.md) | ready | Remove the legacy Admin BillingPlan catalogue/editor/mutation/read-model surface made unreachable by ADMIN-002 while preserving durable BillingPlan state and live operational economics controls. |
