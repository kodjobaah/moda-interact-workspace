...
Current counts: `complete` 9, `ready` 1, `pending` 0
...
| `ADMIN-002` | Review merchant recovery-credit purchase refund requests | Complete | ARCH-010-DATABASE-014, ARCH-010-BACKGROUND-022, ARCH-010-SHOPIFY-025, ARCH-010-SHARED-008, ARCH-010-ADMIN-010 |
| `ADMIN-003` | Lock and settle withdrawn recovery-credit purchases through Shopify Partner Dashboard | **Ready** | ARCH-010-ADMIN-002, ARCH-010-BACKGROUND-022, ARCH-010-SHARED-008, ARCH-010-DATABASE-014, ARCH-010-BACKGROUND-021 |
