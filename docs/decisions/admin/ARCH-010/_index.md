...
| ARCH-010-ADMIN-004 | Ready | SUPER_ADMIN grant one idempotent, audited promotional-credit allocation to an exact shop and show its separate balance/history. |
