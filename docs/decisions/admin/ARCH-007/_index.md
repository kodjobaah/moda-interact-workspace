...
| ADMIN-003 | Build billing overview, tenant detail and Shopify reconciliation visibility | Pending | ADMIN-002, BACKGROUND-007, SHOPIFY-001, BACKGROUND-008 |
...
`ARCH-007-ADMIN-001` Attempt 2 is architect-accepted Complete. `ADMIN-002` is Ready. `ADMIN-005` is also Ready because ADMIN-001, DATABASE-005 and SHARED-006 are Complete. ADMIN-003 remains Pending behind ADMIN-002 and BACKGROUND-008; ADMIN-004 remains Pending behind ADMIN-003/BACKGROUND-008.
