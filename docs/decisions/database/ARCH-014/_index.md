...
| [ARCH-014-DATABASE-003](DATABASE-003-promotion-campaign-translations.md) | ready | Add only the new PromotionCampaignTranslation table for exact 20-locale merchant copy; no existing table alteration. |
