...
| [ARCH-014-DATABASE-004](DATABASE-004-background-runtime-config-and-leases.md) | ready | Add one typed singleton background runtime configuration, versioned audit history, and fenced distributed leases for horizontal scaling. |
