...
|---|---|---|---|
| GATEWAY-001 | Deploy independently scalable billing worker in Render blueprints | **Ready** | BACKGROUND-008 |
...
`ARCH-007-GATEWAY-001` is Ready because `ARCH-007-BACKGROUND-008` is architect-accepted Complete.
