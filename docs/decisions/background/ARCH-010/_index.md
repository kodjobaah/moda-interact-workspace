...
Current counts: `complete` 9, `ready` 2, `pending` 9, `superseded` 2
...
| `BACKGROUND-008` | Make paid recovery initiation safe across the billing-cycle boundary | **Ready** | ARCH-010-BACKGROUND-002, ARCH-010-SHARED-008, ARCH-010-BACKGROUND-019 |
