...
Current counts: `complete` 3, `ready` 3, `pending` 12, `superseded` 2

| Task | Description | Status | Dependencies |
|---|---|---|---|
| `BACKGROUND-001` | Reconcile pending subscription activation with durable BullMQ recovery | **Ready** | ARCH-010-DATABASE-013, ARCH-010-SHARED-008, ARCH-007-BACKGROUND-008 |
...
| `BACKGROUND-011` | Make the lifetime Free recovery entitlement plan-independent and consume it after purchased credits | **Ready** | ARCH-010-DATABASE-013, ARCH-007-BACKGROUND-003, ARCH-007-BACKGROUND-009 |
| `BACKGROUND-012` | Reconcile Shopify cancellation, freeze and unfreeze lifecycle state | Pending | ARCH-010-DATABASE-013, ARCH-010-BACKGROUND-007, ARCH-010-BACKGROUND-010, ARCH-010-SHARED-008, ARCH-010-BACKGROUND-015 |
