...
Current counts: `complete` 10, `ready` 1, `pending` 9, `superseded` 2
...
| `BACKGROUND-009` | Persist recovery exhaustion and resume blocked recoveries when capacity returns | **Ready** | ARCH-010-DATABASE-013, ARCH-010-SHARED-008, ARCH-010-BACKGROUND-002, ARCH-010-BACKGROUND-011, ARCH-007-BACKGROUND-003, ARCH-007-BACKGROUND-009, ARCH-010-BACKGROUND-019 |
