...
| Task | Status | Purpose |
|---|---|---|
| [BACKGROUND-001](BACKGROUND-001-consume-canonical-whatsapp-inbound.md) | Ready | Complete inbound pipeline: Shared event, both reply modes, text/unsupported handling, <=120s voice retrieval/transcription and exactly-once turn completion |
