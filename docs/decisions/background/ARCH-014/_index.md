...
| [ARCH-014-BACKGROUND-004](BACKGROUND-004-messaging-abuse-runtime-controls.md) | ready | Apply runtime messaging settle timing and approved WhatsApp abuse-limit controls using last-known-good configuration. |
