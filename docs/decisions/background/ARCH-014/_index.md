...
| [ARCH-014-BACKGROUND-006](BACKGROUND-006-global-cadence-and-monotonic-lease-fencing.md) | pending | Make PostgreSQL enforce one global periodic cadence window and preserve monotonic fencing generations across normal release/reacquire. |
| [ARCH-014-BACKGROUND-007](BACKGROUND-007-close-runtime-config-authority-gaps.md) | pending | Mirror DB runtime validation, remove production test-default fallbacks, and route remaining periodic billing retry timings through the committed cycle snapshot. |
