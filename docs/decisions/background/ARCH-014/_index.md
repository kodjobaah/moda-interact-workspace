...
| [ARCH-014-BACKGROUND-005](BACKGROUND-005-fleet-wide-bullmq-concurrency.md) | ready | Enforce fleet-wide BullMQ queue concurrency across horizontally scaled worker replicas. |
