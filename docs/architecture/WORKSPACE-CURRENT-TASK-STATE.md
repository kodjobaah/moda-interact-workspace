...
Current counts: `complete` 37, `ready` 4, `pending` 33, `superseded` 7
...
| ARCH-010-SHOPIFY-018 | shopify | **Ready** | 2 | ARCH-010-DATABASE-013, ARCH-010-SHOPIFY-013, ARCH-010-SHOPIFY-023 |
...
Current Ready frontier: `ARCH-010-ADMIN-010`, `ARCH-010-BACKGROUND-008`, `ARCH-010-BACKGROUND-009`, `ARCH-010-SHOPIFY-018`.
