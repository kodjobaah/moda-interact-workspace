...
Current counts: `complete` 38, `ready` 4, `pending` 36, `superseded` 8
...
Current Ready frontier: `ARCH-010-ADMIN-010`, `ARCH-010-BACKGROUND-008`, `ARCH-010-BACKGROUND-009`, `ARCH-010-DATABASE-014`.
