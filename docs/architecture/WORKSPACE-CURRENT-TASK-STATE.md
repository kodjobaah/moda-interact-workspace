...
Current counts: `complete` 32, `ready` 5, `pending` 37, `superseded` 7
...
Current Ready frontier: `ARCH-010-ADMIN-007`, `ARCH-010-ADMIN-010`, `ARCH-010-BACKGROUND-014`, `ARCH-010-BACKGROUND-015`, `ARCH-010-SHOPIFY-023`.
