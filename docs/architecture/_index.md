...
| ARCH-013 | complete 1, ready 1 | [Merchant application routing, navigation and lifecycle coherence](ARCH-013-merchant-application-routing-navigation.md) |
...
- `ARCH-013`: `SHOPIFY-001` remains Complete / Attempt 2 Accepted. A bounded residual correction task, `SHOPIFY-002`, is Ready to suppress an onboarding-only denied purchase-history link and repair the malformed billing UI test module. Billing-v1.1 implementation remains sequenced after SHOPIFY-002 acceptance.
